...
"&display=swap";this.options.debug&&console.log("Loading Google font "+b+" from "+a);c("head").append(c("<link>",{href:a,rel:"stylesheet",type:"text/css"}));break;case "local":"fonts"in document&&"check"in document.fonts&&document.fonts.check("11pt "+b)}},showSample:function(a){c(".fp-sample",
